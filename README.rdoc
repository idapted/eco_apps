...
=== Deploy
It is possible to deploy each of your apps to one domain like app1.example.com, app2.example.com. But, to avoid javascript cross-domain issue and make all your apps looks like one, it's better to serve all your apps in one domain: http://developer.idapted.com/2010/08/03/deploy-dozens-of-rails-applications-into-one-domain/
